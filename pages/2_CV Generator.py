...
#Latex templates inspired by Omar Macias: https://de.overleaf.com/latex/templates/omars-resume/yvmjzbpysxwg
...
with tabs[1]:
    ...
    with st.expander("Education", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        locationus1 = st.text_input("Location 1 (City, Country)", value=locationus1, key="unique_key_145")
        majorus1 = st.text_input("Study Program 1", value=majorus1, key="unique_key_146")
        timeus1 = st.text_input("Time Frame 1 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus1, key="unique_key_147")
        ...
        locationus2 = st.text_input("Location 2 (City, Country)", value=locationus2, key="unique_key_152")
        majorus2 = st.text_input("Study Program 2", value=majorus2, key="unique_key_153")
        timeus2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus2, key="unique_key_154")
...
with tabs[4]:
    ...
    with st.expander("Personal Information", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        name = st.text_input("Full Name (e.g. Max Mustermann)", value=st.session_state['linkedin_data'].get('full_name', ''), key='name_key_5')
    ...
    with st.expander("Education", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        locationus1 = st.text_input("Location 1 (City, Country)", value=locationus1, key="unique_key_219")
        majorus1 = st.text_input("Study Program 1", value=majorus1, key="unique_key_220")
        timeus1 = st.text_input("Time Frame 1 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus1, key="unique_key_221")
        ...
        locationus2 = st.text_input("Location 2 (City, Country)", value=locationus2, key="unique_key_226")
        majorus2 = st.text_input("Study Program 2", value=majorus2, key="unique_key_227")
        timeus2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus2, key="unique_key_228")
    ...
    with st.expander("Professional Experience", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        locatione2 = st.text_input("Location 2 (City, Country)", value=locatione2, key="unique_key_237")
        position2 = st.text_input("Position 2", value=position2, key="unique_key_238")
        timee2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", value=timee2, key="unique_key_239")
        task21 = st.text_area("Tasks 1 (Think about what your responsibilities were)", key='task21_100', height=100)
    ...
    with st.expander("Skills", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        languages1 = st.text_input("Programming Languages", value=languages_combined, key="languages_5_key")
...
with tabs[5]:
    ...
    with st.expander("Personal Information", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        name = st.text_input("Full Name (e.g. Max Mustermann)", value=st.session_state['linkedin_data'].get('full_name', ''), key='name_key_6')
    ...
    with st.expander("Education", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        locationus1 = st.text_input("Location 1 (City, Country)", value=locationus1, key="unique_key_241")
        majorus1 = st.text_input("Study Program 1", value=majorus1, key="unique_key_242")
        timeus1 = st.text_input("Time Frame 1 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus1, key="unique_key_243")
        ...
        locationus2 = st.text_input("Location 2 (City, Country)", value=locationus2, key="unique_key_248")
        majorus2 = st.text_input("Study Program 2", value=majorus2, key="unique_key_249")
        timeus2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", value=timeus2, key="unique_key_250")
    ...
    with st.expander("Teaching / Professional Experience", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        locatione1 = st.text_input("Location 1 (City, Country)", value=locatione1, key="unique_key_255")
        position1 = st.text_input("Position 1", value=position1, key="unique_key_256")
        timee1 = st.text_input("Time Frame 1 (DD.MM.YYYY - DD.MM.YYYY)", value=timee1, key="unique_key_257")
        ...
        locatione2 = st.text_input("Location 2 (City, Country)", value=locatione2, key="unique_key_259")
        position2 = st.text_input("Position 2", value=position2, key="unique_key_260")
        timee2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", value=timee2, key="unique_key_261")
    ...
    with st.expander("Extracurricular Activities", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        certificates1 = st.text_input("Certificates and Awards (e.g. Scholarships)", value=certifications_combined, key="certificates_6_key")

    # Projects Section
    with st.expander("Projects", expanded=False):  # 'expanded=True' means the section will be expanded by default
        projectname1 = st.text_input("Publication 1", key="project_5")
        elocation1 = st.text_input("Location 1 (City, Country)", key="project_language_5")
        ereason1 = st.text_input("Description 1", key="project_function_5")
        timeen1 = st.text_input("Time Frame 1 (DD.MM.YYYY - DD.MM.YYYY)", key="project_time_5")
        ...
        elocation2 = st.text_input("Location 2 (City, Country)", key="project_language_6")
        ereason2 = st.text_input("Description 2", key="project_function_6")
        timeen2 = st.text_input("Time Frame 2 (DD.MM.YYYY - DD.MM.YYYY)", key="project_time_6")
