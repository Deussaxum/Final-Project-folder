...
# Api Key and headers abd api endpoint adress
...
job_type = st.selectbox('Employment type', ['Anything', 'Full Time', 'Part Time', 'Internship', 'Contract', 'Temporary', 'Volunteer']) #all below: dropdown with available options
...
# checks if there are job listings stored in session state and if yes displays them
