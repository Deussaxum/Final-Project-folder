...
with tabs[5]:
    ...
    with st.expander("Projects", expanded=False):  # 'expanded=True' means the section will be expanded by default
        ...
        planguage1 = st.text_input("Programming Language 1", key="project_language_5")
        pfunction1 = st.text_input("Function 1", key="project_function_5")
        timep1 = st.text_input("Time Frame 1", key="project_time_5")
        ...
        planguage2 = st.text_input("Programming Language 1", key="project_language_6")
        pfunction2 = st.text_input("Function 1", key="project_function_6")
        timep2 = st.text_input("Time Frame 1", key="project_time_6")
